...
export default function Eboard(){
	...
	return(
	<>
		<h2 className= "flex justify-center font-bold text-[1.70rem] mb-9! mt-7">Our Team - 2025/2026 E-Board</h2>
		
		<div className = "flex justify-center px-7 pb-10">
			<div className = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-[1250px] w-full text-[0.90rem]">
