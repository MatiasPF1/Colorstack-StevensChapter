...
export default function Navbar() {
  return (
    // Navbar Container 
    <nav className="flex justify-center items-center gap-[30em] h-20  ">

      {/*Left Section: Stevens Name */}
      <Link href="/" className="text-[1.70em] font-bold tracking-[0.02em] text-[#c41230] transition-all duration-200 hover:-translate-y-1 inline-block">
        ColorStack @ Stevens
      </Link>
      ...
      {/* Right Section: Navigation Links */}
        ...
        <li>
          <Link href="/contact" className=" text-[1.00em] no-underline text-[#222629] font-medium transition-all duration-200 hover:text-[#c41230] hover:-translate-y-1 inline-block">
            Contact us
          </Link>
        </li>
